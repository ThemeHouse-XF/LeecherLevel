 ...
 * @version 2.0
 */
class ThemeHouse_LeecherLevel_Util_Equation {
    /**#@+
     *Private variables
     */
	private $postFix;
	 ...
	 *
	 * @see ThemeHouse_LeecherLevel_Util_Equation::solveIF()
	 ...
	 * Sets the internal variable $this->postFix for the ThemeHouse_LeecherLevel_Util_Equation::solvePF()
	 * function to use.
	 *
	...
	public function in2post($infix = null) {
		...
		$pf = array();
		$ops = new ThemeHouse_LeecherLevel_Util_Stack();
		$vars = new ThemeHouse_LeecherLevel_Util_Stack();
	 ...
	 * the RPN array stored in the class from ThemeHouse_LeecherLevel_Util_Equation::in2post(), can take
...
} //end class 'ThemeHouse_LeecherLevel_Util_Equation'